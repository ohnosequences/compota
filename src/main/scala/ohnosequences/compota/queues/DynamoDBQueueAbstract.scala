...
import ohnosequences.compota.{Serializer, Monoid, AWS}
import ohnosequences.awstools.ddb.Utils
import ohnosequences.compota.Tasks
...
// at ohnosequences.compota.queues.DynamoDBQueue.listChunk(DynamoDBQueue.s
//   cala:191)
// at ohnosequences.compota.console.Console.listMessages(Console.scala:263
// )
// at ohnosequences.compota.console.ConsolePlan$$anonfun$intent$1.applyOrE
// lse(Server.scala:99)
// at ohnosequences.compota.console.ConsolePlan$$anonfun$intent$1.applyOrE
// lse(Server.scala:45)
// at scala.PartialFunction$OrElse.apply(PartialFunction.scala:162)
// at ohnosequences.compota.console.Auth$$anonfun$apply$1.applyOrElse(Serv
//   er.scala:30)
// at ohnosequences.compota.console.Auth$$anonfun$apply$1.applyOrElse(Serv
